...
require('config.php');
  ...
  $sql = "SELECT login_cm FROM corps_medical WHERE pk_corps_medical='$id_medecin'";
  $result = mysqli_query($conn, $sql);
  $row = mysqli_fetch_assoc($result);
  $login_medecin = $row["login_cm"];
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 big" style="font-size:18px"><?php echo " DR"." ".$_SESSION['nom_medecin'] ." ". $_SESSION['prenom_medecin'];?><br></span>
...
<div class="d-sm-flex align-items-center justify-content-between mb-5">
    <h6 class="h3 mb-0 text-gray-800">Bienvenu à vous <i><strong><?php echo "Docteur ".$_SESSION['nom_medecin']." ".$_SESSION['prenom_medecin']."(". $login_medecin.")";?>.</strong><i></h6>
